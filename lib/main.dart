...
Future<void> main() async {
  if (kReleaseMode) {
    await SentryFlutter.init(
      (options) {
        options.dsn =
            'https://ccf84ba97449fbbb630f44b9f201c3f4@o4509389243809792.ingest.de.sentry.io/4509389245448272';
        // Set tracesSampleRate to 1.0 to capture 100% of transactions for tracing.
        // We recommend adjusting this value in production.
        options.tracesSampleRate = 0.01;
      },
      appRunner: () =>
          runApp(BetterFeedback(child: SentryWidget(child: const MyApp()))),
    );
